...
public enum ErrorCodes {
	INVALID_HEADER(1001, 400, "Bad Request"), INVALID_FORMAT(1002, 400, "Invalid Data"),
	BAD_REQUEST(1003, 400,"Bad Request"), NOT_ACCEPTABLE(1004, 406, "Not Acceptable"),
	...
	DB_CONNECTION_FAILE(1011, 500,"Internal Server Error"), SERVICE_UNAVAILABLE(1010, 503,"Service Unavailable");
